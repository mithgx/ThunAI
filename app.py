...
# Twilio credentials
TWILIO_ACCOUNT_SID = os.getenv('TWILIO_ACCOUNT_SID', 'REPLACE_WITH_YOUR_TWILIO_ACCOUNT_SID')
TWILIO_AUTH_TOKEN = os.getenv('TWILIO_AUTH_TOKEN', 'REPLACE_WITH_YOUR_TWILIO_AUTH_TOKEN')
TWILIO_PHONE_NUMBER = os.getenv('TWILIO_PHONE_NUMBER', 'REPLACE_WITH_YOUR_TWILIO_PHONE_NUMBER')
POLICE_CONTACT_NUMBER = os.getenv('POLICE_CONTACT_NUMBER', 'REPLACE_WITH_POLICE_CONTACT_NUMBER')

# Set your Google Maps API key
YOUR_GOOGLE_MAPS_API_KEY = os.getenv('GOOGLE_MAPS_API_KEY', 'REPLACE_WITH_YOUR_GOOGLE_MAPS_API_KEY')
